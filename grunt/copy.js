...
module.exports = {
  staging: {
    files: [
        ...
        { cwd: '<%= dirs.source %>/css/', expand: true, src: ['bigfoot-default.css'], dest: '<%= dirs.staging %>/assets/css/' },
  ...
  production: {
    files: [
        ...
        { cwd: '<%= dirs.source %>/css/', expand: true, src: ['bigfoot-default.css'], dest: '<%= dirs.production %>/assets/css/' },
